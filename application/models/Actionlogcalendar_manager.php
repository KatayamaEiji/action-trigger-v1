<?php
class Actionlogcalendar_manager extends CI_Model{
	/**
	 * アクションログカレンダー情報を取得する
	 */
	public function getActionLogCalender($userId,$actionlogfilterParams){
...
from 
	(
		...
		(
			...
			SELECT @num:=@num+1 FROM `information_schema`.COLUMNS LIMIT 42
		) as td
